...
"#;
    ...
    let pack_mcmeta = result.artifacts.files.get("pack.mcmeta").unwrap();
    assert!(pack_mcmeta.contains("\"min_format\": [107, 1]"));
    assert!(pack_mcmeta.contains("\"max_format\": [107, 1]"));
    assert!(pack_mcmeta.contains("Generated by mcfc for Minecraft 26.2"));
    let load_tag = result
        .artifacts
        .files
