...
execute unless data storage anpc:api npc.rotation run data modify storage anpc:api npc.rotation set value [0.0f, 0.0f]
execute unless data storage anpc:api npc.actions run data modify storage anpc:api npc.actions set value []
execute unless data storage anpc:api npc.dialogues run data modify storage anpc:api npc.dialogues set value []

# Store ID
execute store result storage anpc:api npc.id int 1 run scoreboard players get #next anpc.internal.npc.id

# Save npc data
function anpc:internal/npc/npcs/dialogue/save_config with storage anpc:api npc

# Spawn npc
function anpc:internal/npc/npcs/dialogue/spawn with storage anpc:api npc
