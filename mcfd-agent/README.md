...
Verify the named 26.2 mappings against a Minecraft JAR before changing hook
targets:
...
The current 26.2 adapter instruments named vanilla server methods for chat,
...
The adapter is deliberately pinned to Minecraft 26.2. Restart Minecraft
